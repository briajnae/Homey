    ...
    $.post("/api/Affordable_housing", data_object, function () {
      ...
      if (!data.length) {
        ...
        for (i = 0; i < data.length; i++) {
          ...
          $("#results").append("<div id=results-list class=col-md-4 col-lg-4>" + "<img src='" + queryURL + "'> " + "</img>" + "<h3>" + data[i].community_area_name + "</h3>" + "<h4>" + data[i].property_name + "</h4>" + "<p>" + data[i].address + "<p>" + "<p>" + data[i].property_type + "<p>" + "</div>");  
          updateMap();
